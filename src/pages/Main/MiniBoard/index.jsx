...
const MiniBoard = ({ detailUrl, boardUrl, boardReply }) => {
          ...
          <PostInfo>
            <div key={Number(index)}>
              <UserInfoStyle>
                ...
                <UserPostInfo>
                  <UserId>
                    <button type="button">{item.username}</button>
                  </UserId>
                  <PostDate>
                    <button type="button">Feb 5</button>
                  </PostDate>
                </UserPostInfo>
              </UserInfoStyle>
              ...
              <PostStyle>
                <div>
                  <PostHone>
                    <Link to={`/${detailUrl}/detail/${item.id}`}>{item.title}</Link>
                  </PostHone>
                </div>
                ...
                <div>
                  <HashTagUl>
                    <HashTagLi>
                      <HashLink>#webdev</HashLink>
                    </HashTagLi>
                    <HashTagLi>
                      <HashLink>#flask</HashLink>
                    </HashTagLi>
                    <HashTagLi>
                      <HashLink>#stripe</HashLink>
                    </HashTagLi>
                    <HashTagLi>
                      <HashLink>#opensource</HashLink>
                    </HashTagLi>
                  </HashTagUl>
                </div>
                ...
                <PostRest>
                  <IconDiv>
                    <IconLink>
                      <IconA
                        className="crayons-btn crayons-btn--ghost crayons-btn--s crayons-btn--icon-left"
                        href="/mutafakir/the-open-source-alternative-to-notion-1j3m"
                      >
                        ...
                        <IconContent title="Number of reactions">
                          282
                    ...
                    <IconLink>
                      <IconA
                        className="crayons-btn crayons-btn--ghost crayons-btn--s crayons-btn--icon-left"
                        href="/mutafakir/the-open-source-alternative-to-notion-1j3m#comments"
                        aria-label="Comments for post ⭐️ The Open Source Alternative To Notion ⭐️ (26)"
                      >
                        <IconSvg className="crayons-icon" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <IconContent title="Number of comments">
                          {newReplys.filter((a) => a.sameId === item.id).length}
