  ...
  return (
    <SocialNetWorkLinks>
      <NetworkLink
        ...
        target="_blank"
        className="c-link c-link--icon-alone c-link--block mx-1"
        rel="noopener"
      >
        <SvgColor
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="a5ie6k02odc0uh1epnrs2xfom3htwxe9"
          className="crayons-icon c-link__icon"
        >
          <title id="a5ie6k02odc0uh1epnrs2xfom3htwxe9">Twitter</title>
      ...
      >
        <SvgColor
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="a8ua3circawml62xe01yd3ogw0ra80za"
          className="crayons-icon c-link__icon"
        >
          <title id="a8ua3circawml62xe01yd3ogw0ra80za">Facebook</title>
      ...
      >
        <SvgColor
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="apw7vcl49nb7lco1snchqqwfbzm2fvtt"
          className="crayons-icon c-link__icon"
        >
          <title id="apw7vcl49nb7lco1snchqqwfbzm2fvtt">Github</title>
      ...
      >
        <SvgColor
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="atnp26c6yrjltwiw880i9iuyumh4qr7h"
          className="crayons-icon c-link__icon"
        >
          <title id="atnp26c6yrjltwiw880i9iuyumh4qr7h">Instagram</title>
      ...
      >
        <SvgColor
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="af5nvfkqpt8uui7is9pj1gd7c7whm5nj"
          className="crayons-icon c-link__icon"
        >
          <title id="af5nvfkqpt8uui7is9pj1gd7c7whm5nj">Twitch</title>
