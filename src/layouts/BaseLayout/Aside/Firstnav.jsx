            ...
            <nav>
                <UlStyle>
                    ...
                    <LiStyle>
                        ...
                        <NavLink href="https://dev.to/code-of-conduct" className="sidebar-navigation-link c-link c-link--block c-link--icon-left">
                            <IconSpan className="c-link__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                                    <g className="nc-icon-wrapper">
                    ...
                    <LiStyle>
                        ...
                        <NavLink href="https://dev.to/privacy" className="sidebar-navigation-link c-link c-link--block c-link--icon-left">
                            <IconSpan className="c-link__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                                    <g transform="translate(4 4)">
                    ...
                    <LiStyle>
                        ...
                        <NavLink href="https://dev.to/terms" className="sidebar-navigation-link c-link c-link--block c-link--icon-left">
                            <IconSpan className="c-link__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                                    <g transform="translate(4 4)">
