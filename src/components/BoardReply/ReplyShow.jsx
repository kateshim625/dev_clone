          ...
          <DoneComment>
              ...
              <CommentFoldDiv>
                <CommentFoldSpan>
                  <CommentFoldIcon
                    ...
                    viewBox="0 0 24 24"
                    role="img"
                    aria-labelledby="ampvvs6v81z33tfotq2qdq5pqmzh4e2s"
                    className="crayons-icon expanded"
                  >
                    <title id="ampvvs6v81z33tfotq2qdq5pqmzh4e2s">Collapse</title>
            ...
            <CommentDoneBorderSize>
                ...
                <CommentDoneSection>
                  <UserInfoDiv>
                    ...
                    {loginUser === loginid && (
                      <div
                        aria-hidden="true"
                        onClick={ShowTwoButton}
                        className="MoreHiddenMenuDiv"
                        onKeyDown={ShowTwoButton}
                      >
                        {/* 댓글 더보기옵션 버튼 클릭 토글 */}
              ...
              <div>
                <LikeReplyDiv>
                  <LikeReplyBtn
                    className="crayons-btn crayons-btn--ghost crayons-btn--icon-left crayons-btn--s mr-1 reaction-like inline-flex reaction-button"
                    id="button-for-comment-846611"
                    data-comment-id="846611"
                    title="heart"
                    aria-pressed="false"
                    type="button"
                  >
                    <LikeReplyIcon
                      ...
                      height="24"
                      role="img"
                      aria-labelledby="a2k5810zqsl25cmmd7ajhya32do974nw"
                      className="crayons-icon reaction-icon not-reacted"
                    >
                      <title id="a2k5810zqsl25cmmd7ajhya32do974nw">Like comment: </title>
                    ...
                    <span className="reactions-count" id="reactions-count-846611">
                      5
                    </span>
                  ...
                  <LikeReplyBtn type="button">
                    <LikeReplyLink
                      className="actions crayons-btn crayons-btn--ghost crayons-btn--s crayons-btn--icon-left toggle-reply-form mr-1 inline-flex"
                      href="#/arnavkr/using-darklight-mode-specific-images-in-github-markdown-3iln/comments/new/1m49p"
                      data-comment-id="846611"
                      data-path="/arnavkr/using-darklight-mode-specific-images-in-github-markdown-3iln/comments/1m49p"
                      rel="nofollow"
                    >
                      <LikeReplyIcon
                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        height="24"
                        role="img"
                        aria-labelledby="anefzw8fogycapisn0kzkjmroyfygsfx"
                        className="crayons-icon reaction-icon not-reacted"
                      >
                        <title id="anefzw8fogycapisn0kzkjmroyfygsfx">Comment button</title>
